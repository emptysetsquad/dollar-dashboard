...
const AccountPageHeader = ({
  accountESDBalance, accountESDSBalance, accountStagedBalance, accountBondedBalance, accountStatus,
  ...
  <div style={{ padding: '2%', display: 'flex', alignItems: 'center' }}>
    ...
    <div style={{ width: '20%' }}>
      <BalanceBlock asset="Stake" balance={accountESDSBalance}  suffix={" ESDS"}/>
    </div>
    <div style={{ width: '20%' }}>
